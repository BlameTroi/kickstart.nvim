--- ~/.config/kickstart/lua/config/plugins/lsp.lua
...
return {
  ...
  config = function()
    ...
    -- Enable specific langauge servers with their configuration here and not
    -- off in the lsp subdirectory of the rtp.
